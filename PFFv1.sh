...
printf '\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Link Sudah Siap:
\e[0m\e[1;77m %s\n' $send_link
...
sed 's+forwarding_link+'$link'+g' index.html> advance.html
...
sed 's+forwarding_link+'$send_link'+g' index.html > advance.html
